...
c1.markdown(f"<div style='font-size:28px; color:orange;'>Total de pedidos<br><span style='color:black;'>{total}</span></div>", unsafe_allow_html=True)
c2.markdown(f"<div style='font-size:28px; color:green;'>Entregados<br><span style='color:darkgreen;'>{entregados}</span> <span style='color:gray;'>({porc_entregados:.1f}%)</span></div>", unsafe_allow_html=True)
c3.markdown(f"<div style='font-size:28px; color:blue;'>En tránsito<br><span style='color:darkblue;'>{en_transito}</span> <span style='color:gray;'>({porc_transito:.1f}%)</span></div>", unsafe_allow_html=True)
c4.markdown(f"<div style='font-size:28px; color:red;'>Retrasados<br><span style='color:darkred;'>{retrasados}</span> <span style='color:gray;'>({porc_retrasados:.1f}%)</span></div>", unsafe_allow_html=True)
st.divider()
