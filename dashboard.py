...
# 3. CONTENIDO PRIVADO (DASHBOARD)
    ...
    if st.session_state.pagina == "principal":
        ...
        # TÍTULO Y ENCABEZADO
        # --------------------------------------------------
        st.markdown("<style>@keyframes boxLife{0%{transform:translate(0,0);opacity:1;}30%{transform:translate(0,-6px);opacity:1;}60%{transform:translate(0,0);opacity:1;}72%{transform:translate(0,-6px);opacity:1;}78%{transform:translate(-220px,-6px);opacity:1;}82%{opacity:0;}83%{transform:translate(0,0);opacity:0;}86%{opacity:1;}100%{transform:translate(0,0);opacity:1;}}</style><h2 style='text-align:center;display:flex;align-items:center;justify-content:center;gap:14px;font-weight:600;color:#FFFFFF;'><svg style='animation:boxLife 9s cubic-bezier(.4,0,.6,1) infinite;' width='34' height='34' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'><path d='M3 7L12 2L21 7L12 12L3 7Z' stroke='#00FFAA' stroke-width='1.5' stroke-linejoin='round'/><path d='M3 7V17L12 22L21 17V7' stroke='#00FFAA' stroke-width='1.5' stroke-linejoin='round'/><path d='M12 12V22' stroke='#00FFAA' stroke-width='1.5'/><path d='M7.5 4.8L16.5 9.3' stroke='#00FFAA' stroke-width='1.1' opacity='0.6'/></svg><span>Control de Embarques</span></h2>", unsafe_allow_html=True)
