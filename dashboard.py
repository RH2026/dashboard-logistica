...
c1.markdown(f"<div style='font-size:18px; color:yellow;'>Total de pedidos<br><span style='color:white;'>{total}</span></div>", unsafe_allow_html=True)
c2.markdown(f"<div style='font-size:18px; color:yellow;'>Entregados<br><span style='color:white;'>{entregados}</span> <span style='color:gray;'>({porc_entregados:.1f}%)</span></div>", unsafe_allow_html=True)
c3.markdown(f"<div style='font-size:18px; color:yellow;'>En tránsito<br><span style='color:white;'>{en_transito}</span> <span style='color:gray;'>({porc_transito:.1f}%)</span></div>", unsafe_allow_html=True)
c4.markdown(f"<div style='font-size:18px; color:yellow;'>Retrasados<br><span style='color:white;'>{retrasados}</span> <span style='color:gray;'>({porc_retrasados:.1f}%)</span></div>", unsafe_allow_html=True)
st.divider()
