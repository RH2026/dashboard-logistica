...
# 3. CONTENIDO PRIVADO (DASHBOARD)
    ...
    if st.session_state.pagina == "principal":
        ...
        # TÍTULO Y ENCABEZADO
        # --------------------------------------------------
        st.sidebar.markdown(f"""<div style="display:flex;flex-direction:column;align-items:center;justify-content:center;width:100%;padding:20px 0;border-bottom:1px solid rgba(255,255,255,0.1);margin-bottom:20px;"><img src="{icon_azul}" width="65" style="margin-bottom:15px;filter:drop-shadow(0px 0px 8px rgba(0,176,255,0.4));"><div style="text-align:center;"><span style="color:#888;font-size:11px;text-transform:uppercase;letter-spacing:1.5px;font-family:sans-serif;">Sesión Activa</span><div style="height:5px;"></div><span style="color:#00FFAA;font-size:22px;font-weight:bold;font-family:'Courier Prime',monospace;">{st.session_state.usuario_actual}</span></div></div>""", unsafe_allow_html=True)
