...
# 3. CONTENIDO PRIVADO (DASHBOARD)
    ...
    # ------------------------------------------------------------------
        ...
        st.write("🧪 PRUEBA DIRECTA DE CARGA DESDE GOOGLE SHEETS")
        ...
        try:
            ...
            st.error(f"ERROR AL LEER SHEET: {e}")
            st.stop()
    
        st.write("Filas cargadas:", len(df_test))
        st.write("Columnas:", list(df_test.columns))
