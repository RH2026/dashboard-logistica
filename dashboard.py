    ...
    # ------------------------------------------------------------------
        ...
        st.markdown("""
            <style>
                ...
                /* --- ELIMINACIÓN TOTAL DEL TEXTO "RUNNING" --- */
                
                [data-testid="stStatusWidget"] {
                    background-color: transparent !important;
                    border: none !important;
                    box-shadow: none !important;
                    visibility: hidden !important; /* Oculta el contenedor */
                    height: 0px !important;
                }

                [data-testid="stStatusWidget"] > div {
                    display: none !important; /* Borra el texto y el circulito mini original */
                }

                /* --- TU CÍRCULO GENIAL (SE MANTIENE VISIBLE) --- */
                [data-testid="stStatusWidget"]::after {
                    content: "";
                    visibility: visible !important; /* Esto hace que SOLO el círculo se vea */
                    position: fixed;
                    top: 50%;
                    left: 50%;
        ...
        try:
            ...
            with h1:
                f_ini = st.date_input("Periodo Inicio", value=None, key=f"f_a_{v}")
            with h2:
